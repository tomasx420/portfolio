<script>
    export let heading = "WELCOME TO MY PORTFOLIO";
...
<style>
    ...
    .portfolio-animation::before {
        content: 'Portfolio';
        position: absolute;
        left: 0;
        right: 0;
        color: #424242;  /* Text and Headers color */
        white-space: nowrap;
        overflow: hidden;
        animation: wipeColorChange 6s ease-in-out infinite;
    }
